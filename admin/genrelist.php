...
<div class="container-fluid">
    ...
    <hr>
    <table class="table table-striped table-bordered text-center ms-3 mt-1" style="margin-left:200px; width:80%;">
        <thead>
            <tr>
                <th scope="col">Id</th>
...
if ($run2) {
 ...
 ?>
      ...
      ?>&catid=<?php echo$row['category_id']; ?>&genreid=<?php echo$row['genreid']; ?>">EDIT</a>
                </td>
            </tr>
            <?php
  		}
