<?php
// Include necessary PHP files (assuming these contain your database connection and functions)
include 'db.php'; // Make sure db.php includes your database connection code
include 'ft.php'; // Include any other necessary PHP functions or configurations
?>
<!DOCTYPE html>
<html lang="en">
<head>
